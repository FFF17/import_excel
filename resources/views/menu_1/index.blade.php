                                ...
                                <div class="table-responsive m-t-40">
                                 ...
                                 @if($data->status == 2)   
                                     ...
                                     <td>
                                                ...
                                                <a href="{{route('downloadpdfsiswa1',[$data->id])}} " class="btn btn-xs btn-info btn-xs m-b-10 m-l-5"><i class="fa fa-print"></i> </a>


                                             <a href="{{url('menu_1/edit/'.$data->id) }} " class="btn btn-xs btn-warning  btn-xs m-b-10 m-l-5"><i class="fa fa-edit"></i> </a>
